...
import { getElementorAssets } from "../../lib/wp/elementor-assets";
import { loadCssRegistry, mergeCssRegistry } from "../../lib/wp/css-registry";
import { loadJsRegistry, mergeJsRegistry } from "../../lib/wp/js-registry";
import { getStyles } from "../../lib/wp/load-migrated";
import { getWordPressSourceUrl } from "../../lib/wp/source-url";
import type { PageShellAssets, StylesManifest } from "../../lib/wp/types";
import { readRegistry, urlToSlug } from "../../lib/wp/sites";
...
import {
  ...
  persistJsRegistry,
  resetJsRegistry,
} from "../core/lib/js-download";
import { buildPageAssetGraph } from "../core/lib/asset-graph";
import {
  persistFontRegistry,
  resetFontRegistry,
} from "../core/lib/font-download";
import { mirrorPageAssetGraph } from "../core/lib/mirror-page-assets";
import { routeToPageKey } from "../core/lib/page-key";
...
async function fetchLiveAssetOrder(): Promise<{
  ...
  const { wpHttpFetch } = await import("../../lib/wp/http");
