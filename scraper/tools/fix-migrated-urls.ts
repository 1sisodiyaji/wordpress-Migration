...
import { MIGRATED_DATA_DIR, getWpUrl } from "../../lib/wp/config";
import { sanitizeMigratedUrls } from "../core/lib/sanitize-urls";
...
async function main(): Promise<void> {
  ...
  for (const file of files) {
    ...
    const out = sanitizeMigratedUrls(raw, getWpUrl());
    if (out !== raw) {
