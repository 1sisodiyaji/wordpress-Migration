...
function hostLatestDir(): string {
  return path.join(ROOT, "Docker", "try-data", "radius-ois", "www", "wp-content", "uploads", "wp-grape-export", "latest");
}

function hostLatestZip(): string {
  return path.join(ROOT, "Docker", "try-data", "radius-ois", "www", "wp-content", "uploads", "wp-grape-export", "latest.zip");
}

function hostLatestResultFile(): string {
  return path.join(ROOT, "Docker", "try-data", "radius-ois", "www", "wp-content", "uploads", "wp-grape-export", "latest-result.json");
}
...
export async function syncLocalPluginExport(
  ...
  console.log(`\n▶ Import ${source} → Projects/${siteSlug}/\n`);
